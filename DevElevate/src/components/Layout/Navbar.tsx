...
const Navbar: React.FC = () => {
  ...
  return (
    <>
      <nav className={`${state.darkMode ? 'bg-gray-900 border-gray-700' : 'bg-white border-gray-200'} border-b transition-colors duration-300 ease-in-out sticky top-0 z-40`}>
  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div className="flex justify-between items-center h-16">
      ...
      <div className="flex items-center">
        <Link to="/" className="flex items-center space-x-2 group transition-transform duration-200 hover:scale-105">
          ...
          <span className={`text-xl font-bold transition-colors duration-200 ${state.darkMode ? 'text-white' : 'text-gray-900'}`}>
            DevElevate
          </span>
        </Link>
      </div>
        ...
        {navItems.map((item) => {
          ...
          return (
            <Link
              key={item.path}
              to={item.path}
              className={`flex items-center space-x-2 px-3 py-2 rounded-lg text-sm font-medium transition-all duration-300 ease-in-out transform hover:scale-[1.02] ${
                isActive(item.path)
      ...
      <div className="flex items-center space-x-2">
        ...
        <button
          ...
          className={`p-2 rounded-lg transition-all duration-200 ease-in-out hover:scale-110 ${
        ...
        <button
          ...
          className={`relative p-2 rounded-lg transition-all duration-200 ease-in-out hover:scale-110 ${
            showNotifications
        ...
        <button
          ...
          className={`p-2 rounded-lg transition-all duration-300 ease-in-out hover:scale-110 ${
            state.darkMode ? 'hover:bg-gray-800 text-gray-400 hover:text-white' : 'hover:bg-gray-100 text-gray-600 hover:text-gray-900'
          }`}
          title="Toggle theme"
        >
        ...
        <div className="relative">
          <button
            ...
            className={`flex items-center space-x-2 p-1 rounded-lg transition-all duration-200 ease-in-out hover:scale-105 ${
              showProfile
        ...
        <button
          ...
          className={`lg:hidden p-2 rounded-lg transition-all duration-200 ease-in-out hover:scale-110 ${
    ...
    {showMobileMenu && (
      <div className={`lg:hidden border-t transition-all duration-300 ease-in-out ${state.darkMode ? 'border-gray-700' : 'border-gray-200'} py-4`}>
          ...
          {navItems.map((item) => {
            ...
            return (
              <Link
                ...
                className={`flex items-center space-x-3 px-3 py-2 rounded-lg text-sm font-medium transition-all duration-200 ease-in-out hover:scale-105 ${
                  isActive(item.path)
