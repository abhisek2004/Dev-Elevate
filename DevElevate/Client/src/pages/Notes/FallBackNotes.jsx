  ...
  useEffect(() => {
    const loadSubjectData = async () => {
      try {
        ...
        const notesFiles = import.meta.glob(
          "../../assets/json/notesfolder/*.json"
        );
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 py-12 md:py-16 lg:py-20">
        ...
        >
          ...
          >
            Access curated notes, study materials, and resources for {topic} to
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {subjectData.map((item, ind) => {
            return <NotesCard key={ind} isDark={isDark} item={item} />;
          })}
        </div>
      </div>
    </div>
