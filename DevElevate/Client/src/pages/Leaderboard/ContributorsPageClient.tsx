        ...
        <main className="min-h-screen py-24 px-4 sm:px-8 lg:px-16 bg-background text-white">
          <div className="max-w-7xl mx-auto text-center">
            <div className="bg-red-500/10 border border-red-500/20 rounded-lg p-8">
              ...
              <button onClick={() => window.location.reload()} className="inline-flex items-center px-4 py-2 rounded-lg border text-sm bg-red-500/20 hover:bg-red-500/30 border-red-500/30">
                Try Again
              </button>
            </div>
          </div>
            ...
            <div className="bg-gradient-to-r from-purple-500/10 via-blue-500/10 to-pink-500/10 rounded-2xl p-8 border border-white/10 text-center">
              ...
              <div className="flex justify-center">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 px-5 py-3 rounded-lg text-white bg-gradient-to-r from-purple-500 to-blue-500 hover:from-purple-600 hover:to-blue-600 shadow"
                >
