...
const SearchModal: React.FC<SearchModalProps> = ({ isOpen, onClose }) => {
  ...
  const searchableContent = [
    ...
    // Features
    {
      ...
      path: "/chatbot",
      icon: MessageSquare,
      description: "Get AI-powered help with your queries",
    },
    {
      type: "feature",
    ...
    },
    {
      ...
      path: "/placement",
      icon: Target,
      description: "Interview prep and job opportunities",
    },
    {
      type: "feature",
    ...
    // Topics
    {
      ...
      path: "/learning?topic=arrays",
      icon: BookOpen,
      description: "Learn array manipulation and string algorithms",
    },
    {
      type: "topic",
      title: "Binary Trees",
      path: "/learning?topic=trees",
      icon: BookOpen,
      description: "Tree data structures and traversals",
    },
    {
      type: "topic",
      title: "Dynamic Programming",
      path: "/learning?topic=dp",
      icon: BookOpen,
    ...
    },
    {
      type: "topic",
      title: "System Design",
      path: "/learning?topic=system-design",
      icon: BookOpen,
    ...
    },
    {
      ...
      path: "/",
      icon: Target,
      description: "Set and achieve daily learning goals",
    },
  ];
