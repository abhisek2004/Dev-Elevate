...
//   // ... rest of your data and helper functions ...

//   // Helper to render tab content
//   const renderTabContent = () => {
//     if (selectedTab === 'opportunities') return renderOpportunities();
//     if (selectedTab === 'interviews') return renderInterviews();
//     if (selectedTab === 'resources') return renderResources();
//     if (selectedTab === 'mock') return renderMockInterviews();
//     return null;
//   };
...
//             {tabs.map(tab => {
//               const Icon = tab.icon;
//               function setSelectedTab(_id: any): void {
