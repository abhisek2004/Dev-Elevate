...
const QuizPage: React.FC = () => {
  ...
  return (
    <div className={`min-h-screen p-6 ${state.darkMode ? 'bg-gray-900 text-white' : 'bg-gray-50 text-gray-900'}`}>
      <div className="max-w-6xl mx-auto">
              ...
              >
                <div className="flex items-start justify-between mb-4">
                  <div className="flex items-center space-x-2">
                    ...
                    <span className={`text-sm font-medium ${quiz.type === 'MCQ' ? 'text-blue-600' : 'text-purple-600'}`}>
                      {quiz.type}
                    </span>
                  </div>
        ...
        {!loading && quizzes.length === 0 && (
          <div className={`text-center py-12 ${state.darkMode ? 'text-gray-400' : 'text-gray-600'}`}>
